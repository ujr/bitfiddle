...
\line{\hss 2020 $\cdot$ CC-\kern-.1ex BY\kern-.3ex-SA\hss}
\vskip4pt\hrule
}
...
\halign to\hsize{\tabskip=1pc plus 1ex minus .5ex
  ...
  #\hfil&\hfil#\hfil&\hfil#\hfil&\hfil#\hfil\cr
...
ratio:& $1$ &$1.19$&$1.32$&$1.50$&$1.59$&$1.78$&$2$& the ratios of\cr
      &$1/1$&$6/5$&$4/3$&$3/2$&$8/5$&$16/9$&$2/1$& just intonation\cr
 note:& C & E$\flat$ & F& G& A$\flat$& B$\flat$& C$'$& C minor\cr}
...
\smallskip
\halign{\tabskip=1.5ex\hfil#&\tt#\hfil&#\hfil&#\hfil\cr
1.&BY\char"7D\relax6YB6\%&
 corresponding to F A$\flat$ C$'$ E$\flat$ A$\flat$ F E$\flat$ C&
 for {\tt 3\&(i>>16)} in $1,2,3$\cr
2.&Qj\char"7D\relax6jQ6\%&
 corresponding to G B$\flat$ C$'$ E$\flat$ B$\flat$ G E$\flat$ C&
 for {\tt 3\&(i>>16)} $=0$\cr}
\smallskip
\noindent{\bf First voice:} controlled by ${\tt n}={\tt i}/2^{14}$,
